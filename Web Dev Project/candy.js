var fruits=["apple","grapes","kiwi","orange","pineapple","strawberry","watermelon"]
var rows=10;
var columns =10;
var score=0;
var board=[];
...
function dragEnd(){
    if (current_tile.src.includes("blank")||other_tile.src.includes("blank")){
        return;
    }
...
function crushFour(){
    for(let r=0;r<rows;r++){
        for(let c=0;c<columns-3;c++){
            ...
            if(fruit1.src==fruit2.src && fruit2.src==fruit3.src && fruit3.src==fruit4.src && !fruit1.src.includes("blank")){
                fruit1.src="./blank.png";
                fruit2.src="./blank.png";
                fruit3.src="./blank.png";
...
function crushFive(){
    for(let r=0;r<rows;r++){
        for(let c=0;c<columns-4;c++){
            ...
            if(fruit1.src==fruit2.src && fruit2.src==fruit3.src && fruit3.src==fruit4.src && fruit4.src==fruit5.src && !fruit1.src.includes("blank")){
                fruit1.src="./blank.png";
                fruit2.src="./blank.png";
                fruit3.src="./blank.png";
                fruit4.src="./blank.png";
